...
public class Quadratic{
	public static double quadY(double x, double a, double b, double c){
		...
		*/
      if ( a < 0 && (x == Double.NEGATIVE_INFINITY || x == Double.POSITIVE_INFINITY) ) return Double.NEGATIVE_INFINITY;
      if ( a > 0 && (x == Double.NEGATIVE_INFINITY || x == Double.POSITIVE_INFINITY) ) return Double.POSITIVE_INFINITY;
